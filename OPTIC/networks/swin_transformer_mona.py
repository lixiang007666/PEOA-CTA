...
class bbaOp(nn.Module):
    def __init__(self, in_features):
        ...
        self.conv1 = nn.Conv2d(
            in_features, in_features, kernel_size=3, padding=3 // 2, groups=in_features
        )
        self.conv2 = nn.Conv2d(
            in_features, in_features, kernel_size=5, padding=5 // 2, groups=in_features
        )
        self.conv3 = nn.Conv2d(
            in_features, in_features, kernel_size=7, padding=7 // 2, groups=in_features
        )
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        self.my_module_1 = bba(dim, 8)
        self.my_module_2 = bba(dim, 8)  # Adapter_FFN(dim, 8)
...
class SwinTransformer_bba(nn.Module):
    ...
    def train(self, mode=True):
        ...
        super(SwinTransformer_bba, self).train(mode)
        self._freeze_stages()
